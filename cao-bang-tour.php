            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="md:col-span-1">
                    <div class="p-6 rounded-xl" style="background:#fff; color:#1D292C;">
                        ...
                        <p class="mb-4" style="font-family:'Inter',sans-serif; font-size:12px; line-height:20px; color:rgba(29,41,44,.7);"><?php echo $current_lang === 'en' ? "per adult" : "một người lớn" ?></p>
                        <?php
                        ...
                        <p class="mb-2" style="font-family:'Inter',sans-serif; font-size:15px; line-height:24px; font-weight:600;">
                            <?php echo $current_lang === 'en' ? 'included' : 'giá bao gồm' ?>
                        </p>
                        <ul class="space-y-2 mb-6" style="font-family:'Inter',sans-serif; font-size:15px; line-height:24px;">
                            <li class="flex items-start">
                                <?php echo $check_icon; ?>
                                <?php echo $current_lang === 'en' ? 'Round-trip sleeper bus ticket: Hanoi - Cao Bang' : 'Vé xe khứ hồi Hà Nội - Cao Bằng' ?>
                            </li>
                            <li class="flex items-start">
                                <?php echo $check_icon; ?>
                            ...
                            <li class="flex items-start">
                                <?php echo $check_icon; ?>
                                <?php echo $current_lang === 'en' ? 'Easy riders' : 'Thuê người lái' ?>
                            </li>
                            <li class="flex items-start">
                                <?php echo $check_icon; ?>
