...
foreach ($highlights as $index => &$highlight) {
    $locale_index = $hue_highlight_specs[$index]['locale_index'];
    $highlight['summary_en'] = $hue["highlight_item_{$locale_index}_summary"] ?? '';
    $highlight['summary_vi'] = $highlight['summary_en'];
    $highlight['keywords_en'] = $hue["highlight_item_{$locale_index}_keywords"] ?? [];
