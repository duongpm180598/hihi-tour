...
$keelung_trail_images = hihi_image_group('taiwan.keelung_trail');
$liushishi_images = hihi_image_group('taiwan.liushishi');
$qixingtan_images = hihi_image_group('taiwan.qixingtan');
...
<div class="gallery-container overflow-x-hidden">
    ...
    <section id="overview" style="position:relative;">
        ...
        <div class="overview-hero-media" style="width:100%; height:clamp(350px, 45vw, 560px); overflow:hidden; position:relative;">
            ...
            <?php
            $vibe_destination_title = $taiwan['seo_h1'] ?? $taiwan['destination_title'];
